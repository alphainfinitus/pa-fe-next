...
import { useNetworkSocialsQuery } from '../../generated/graphql';
...
const Footer = ({ className }:{ className?: string } ): JSX.Element => {
	...
	const siteLinks = <>
		<div className="help-center-links">
			...
			<div className='flex-col'>
				<Link href="/terms-and-conditions" passHref><a className='footer-link'>Terms and Conditions</a></Link>
		...
		<div className="pa-links">
			<h3>Polkassembly</h3>
			<div className='flex-col'>
				<Link href="/terms-of-website" passHref><a className='footer-link'>Terms of Website</a></Link>
				<Link href="/privacy" passHref><a className='footer-link'>Privacy Policy</a></Link>
			</div>
		</div>
	</>;
	...
	return (
		<footer className={className}>
			<div className="flex">
				<div className="logo">
					<Image alt='Polkassembly Logo' className='logo-img' width={250} height={85} src='/static/polkassembly-logo.png' />
				</div>
