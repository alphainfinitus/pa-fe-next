...
import { Button, Form, Grid, Icon, Image as SUIImg, Input, Label, Message, Modal, TextArea } from 'semantic-ui-react';

import { NotificationContext } from '../../context/NotificationContext';
import { Exact, GetUserDetailsQuery, useAddProfileMutation } from '../../generated/graphql';
			...
			<div className='profile-image'>
				{userImage || finalImgUrl ?
					<div className='image-div'>
						<SUIImg width={130} height={130} className='profile-img' src={finalImgUrl ? finalImgUrl : userImage} />
						{updatePhotoButton}
					</div>
					: <div className='no-image-div'>
						<Image width={130} height={130} className='profile-img' alt='No Profile Photo' src='/static/no-user-img.png' />
						{updatePhotoButton}
					</div>
				}
			</div>
