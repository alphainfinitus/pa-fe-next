...
import { Button, Card, Divider, Grid, Icon, Image as SUIImg, Label } from 'semantic-ui-react';
									...
									<div className='profile-div'>
										{data.userDetails?.image ?
											<div className='image-div'>
												<SUIImg width={130} height={130} className='profile-img' src={data.userDetails?.image} />
											</div>
