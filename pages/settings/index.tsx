...
import Email from '../../src/screens/Settings/email';
import Password from '../../src/screens/Settings/password';
import Username from '../../src/screens/Settings/username';

interface Props {
	className?: string
}

const SetOnChainIdentityButton = dynamic(() => import('../../src/screens/Settings/setOnChainIdentityButton'), {
	ssr: false
});

const SetCredentials = dynamic(() => import('../../src/screens/Settings/setCredentials'), {
	ssr: false
});

const Address = dynamic(() => import('../../src/screens/Settings/address'), {
	ssr: false
});

const Multisig = dynamic(() => import('../../src/screens/Settings/multisig'), {
	ssr: false
});
